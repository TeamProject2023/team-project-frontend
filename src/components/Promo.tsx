...
export const Promo: FC = () => {
    return (
        <div className="promo__container">
            <PromoSegment image={wheelchair} title="title" text="Text for Segment 1" />
            <PromoSegment image={wheelchair} title="title" text="Text for Segment 2" />
            <PromoSegment image={wheelchair} title="title" text="Text for Segment 3" />
        </div>
    );
};
