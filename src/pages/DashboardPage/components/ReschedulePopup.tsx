...
export const ReschedulePopup: React.FC<ReschedulePopupProps> = ({ showPopup, togglePopup, appointmentData }) => {
    ...
    const handleRescheduleAppointment = async () => {
        const res = await AppService.rescheduleAppointment(appointmentData._id, {
